...
public class TradePublisherService {
	Logger logger = LoggerFactory.getLogger(TradePublisherService.class);
	...
	public void publishTrade(Trade trade) {
		//not publishing DB entry as id can be sensitive
		logger.debug("publishTrade: Publishing trade "+trade);
